        ...
        <div id="navigation">
            ...
            ?>
                    ...
                    <form action="" method="POST">
                        ...
                        <input name="goldName" type="text" value="<?php echo $row['Account']  ?>" />
                        <br>
                        <br>
...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE `GregorGold` SET `Account` = '" . $goldName . "',`Gold20` = '" . $gold20 . "', `Gold100` = '" . $gold100 . "', `Gold200` = '" . $gold200 . "', `Gold500` = '" . $gold500 . "', `Gold1000` = '" . $gold1000 . "', 
